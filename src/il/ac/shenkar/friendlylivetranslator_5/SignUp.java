...
public class SignUp extends Activity 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
		...
		/**
		 * Button which switches back to the login screen on click
		 **/
        backSign = (Button) findViewById(R.id.back);
           ...
           try 
           {
        	   if (json.getString(KEY_SUCCESS) != null) 
        	   {
                   ...
                   if(Integer.parseInt(res) == 1)
                   {
                        ...
                        **/
                       Intent registered = new Intent(getApplicationContext(), SignedUp.class);
