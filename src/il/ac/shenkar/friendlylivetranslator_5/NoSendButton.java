...
public class NoSendButton extends Activity implements RoomRequestListener, NotifyListener, OnInitListener
{	
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		inputEditText.setOnEditorActionListener(new OnEditorActionListener() 
		{
		    ...
		    {	    	
		        ...
		        {		
	            	...
	            	outputView.append("\n"+currUser+": "+original);
		        	Toast.makeText(NoSendButton.this,"Translating & Sending",Toast.LENGTH_SHORT).show();
		...
		mic.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
		         ...
		         {
		        	 Toast.makeText(NoSendButton.this, "Error initializing speech to text engine.", Toast.LENGTH_LONG).show();
		         }
			}
		});
	...
	public void onGetLiveRoomInfoDone(final LiveRoomInfoEvent event) 
	{
		...
		if(event.getResult()==0)
		{
			...
			{ // Alert for no online user found
				runOnUiThread(new Runnable() 
				{
					...
					public void run() 
					{
						Utils.showToast(NoSendButton.this, "No online user found");
					}
				});
		...
		else
		{
			runOnUiThread(new Runnable() 
			{
				...
				public void run() 
				{
					Utils.showToast(NoSendButton.this, "Error in fetching data. Please try later");
				}
			});			
		}
	}
	...
	public void onInit(int status) 
	{
	    ...
	    {
            Toast.makeText(NoSendButton.this,"Error occurred while initializing engine", Toast.LENGTH_SHORT).show();	        
	    }
	}
	
	//The function that inserts the text from Google Speech
    @Override
	public void onActivityResult(int requestCode, int resultCode, Intent data) 
    {
        ...
        if (requestCode==REQUEST_OK) 
        {
        	...
        	inputEditText.setText(thingsYouSaid.get(0));
        	original=inputEditText.getText().toString();
        	outputView.append("\n"+currUser+": "+original);
        	Toast.makeText(NoSendButton.this,"Translating & Sending",Toast.LENGTH_SHORT).show();
        	new MyAsyncTask().execute();            	       	
