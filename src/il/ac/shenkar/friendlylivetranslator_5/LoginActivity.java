...
public class LoginActivity extends Activity 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        BtnSignup = (Button) findViewById(R.id.ButtonBack);
        btnLogin = (Button) findViewById(R.id.done);
		 ...
		 * A toast is set to alert when the email and password fields are empty.
		 **/
    ...
    private class NetCheck extends AsyncTask<String,String,Boolean>
    {
        ...
        /**
         * Gets current device state and checks for working internet connection by trying Google.com
         **/
        @Override
    ...
    /**
     * Asynctask to get and send data to MySql database through JSON respone
     **/
